...
| process-brine assays (sabkha, Atacama, Mackay, GSL, Salton Sea, Red Sea sabkha, Kutch, Texas desal-reject, Mediterranean SWRO) | Cited inland/coastal process-brine or desal-reject majors (not Millero seawater). Gulf sabkha Wood 2002 / MDPI Hydrology 2020; Atacama + GSL Murphy & Haji 2022 Table 1; Lake Mackay Agrimin EPA memo medians; Salton Sea Stringfellow & Dobson 2021 Energies Table 2 / NREL TEA OSTI 1782801 ppm family; Jizan Red Sea sabkha Basyoni & Mousa 2016 Table 2 means; Kutch Rebary & Patidar 2021 Table 6 medians; Corpus Christi PCCA design-basis Outfall 001; Villar et al. 2023 Mediterranean SWRO reject. Screening densities 1.20 / 1.23 / 1.16 / 1.10 / 1.20 / 1.12 / 1.10 / 1.051 / 1.054 kg/L. Ions omitted when not in the cite (no invented Li+/Br−). | Preset `site.resources.brine` / `createAbundanceCase({ assayId })` | **cited** (composition) + **screening** (density, intake volume) | Frozen 2026-09-20 in `data/*-brine.json` (Salton Sea + coast dual-assay files 2026-09-21). Bound where geography holds (Taweelah/Ras Laffan/Ras Al-Khair → sabkha; Mejillones → Atacama nucleus; Port Hedland/Kwinana → Lake Mackay regional; Oxagon/Sokhna/Yanbu → Jizan sabkha; Mundra → Kutch; Corpus Christi → PCCA desal-reject; Almería → Mediterranean SWRO; inland `au-lake-mackay`, `us-great-salt-lake`, `us-salton-sea`). Duqm/Agadir/Dakhla/Walvis permanent-skip (no cited mean). Literature ≠ concession. |
