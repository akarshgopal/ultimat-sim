  ...
  return {
    ...
    graph: {
      nodes: [
        ...
        { id: 'dac', unit: 'dac', capacity: 100, params: params.dac, economics: tea.bindCapexPack('dac', { capacity: 100 }) },
        { id: 'swro', unit: 'swro', capacity: 10, params: params.swro, economics: tea.bindCapexPack('swro', { capacity: 10 }) },
        { id: 'electrical-bus', unit: 'electrical-bus' },
        {
          ...
          economics: tea.bindCapexPack('electrolyzer', { capacity: 100 }),
        },
        {
          id: 'sabatier',
          unit: 'sabatier',
          ...
          economics: tea.bindCapexPack('sabatier', { capacity: sabatierCapacity }),
        },
        ...
        { id: 'methane', unit: 'material-sink', economics: tea.bindSale('methane') },
        ...(recycleWater
