  ...
  buildSiteFootprintEstimate(r) {
    ...
    const rawItems = [
      ...
      },
      {
        id: 'desalination',
        label: 'Desalination',
        areaM2: r.waterSystems?.enabled ? Math.max(18, (r.waterSystems.dailyM3 || 0) * 0.8) : 0,
      },
      {
        id: 'brineMining',
        label: 'Brine mining',
        areaM2: r.waterSystems?.mining ? Math.max(18, (r.waterSystems.mining.brineConsumedDailyM3 || 0) * 1.2) : 0,
      },
    ];
