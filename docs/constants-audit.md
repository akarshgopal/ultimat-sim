...
| `data/*-seawater.json` + `site-assays.js` | Regional Millero-scale assays (Gulf 40.5, Red Sea 40.5, Texas 36.2, Pilbara 35.5, Atacama 34.9, Morocco 36.5) | Preset site.assay / seawater resource | **cited** (composition) + **screening** (intake volume) | Frozen 2026-09-13. Same Millero majors scaled by cited regional salinity. Registry binds on preset select; Oman/Mundra/Walvis stay screening without fabricated ions. |
