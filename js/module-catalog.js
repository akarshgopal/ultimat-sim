...
const MODULE_CATALOG = Object.freeze([
  ...
  normalizeModuleDefinition({
    ...
    routes: {
      'salt-suite': {
        label: 'NaCl + Mg(OH)₂ + gypsum + Br₂',
        electricityKwhPerUnit: 0.15,
        capexPerAnnualUnit: 3500,
        capexUnit: 'tpa',
        cyclingPenalty: 1.15,
        feedstocks: { brineM3: 1 },
      ...
      'salton-geothermal-li': {
        label: 'Salton geothermal lithium (analog)',
        electricityKwhPerUnit: 2.5,
        capexPerAnnualUnit: 18000,
        capexUnit: 'tpa',
        cyclingPenalty: 1.25,
        feedstocks: { brineM3: 1 },
    ...
    missingInputs: [
      'Product separation, reagent consumption, and brine reinjection boundary',
      'Weak literature: reported economics span several orders of magnitude',
      'Bulk salt market absorption can dominate realized revenue',
    ],
  }),
  normalizeModuleDefinition({
    id: 'desalination',
    ...
    routes: {
      ...
      thermal: {
        ...
        electricityKwhPerUnit: 2,
        capexPerAnnualUnit: 2000,
        thermalKwhPerUnit: 50,
        temperatureC: 70,
        gor: 10,
        capexUnit: 'm3pd',
        cyclingPenalty: 1.25,
    ...
    missingInputs: [
      ...
      'Weak literature: intermittent RO cycling data are bench-scale; MED cheapness is scenario-only',
    ],
  }),
]);
