...
const PROCESS_INTENSITIES = Object.freeze({
  ...
  'dac-electroswing': Object.freeze({
    ...
    evidence: Object.freeze([
      Object.freeze({
        label: 'Frontiers 2025 assumes ESA ≈ TVSA 1.12 m²/(t·y); no commercial ESA-DAC plot survey',
        url: 'https://www.frontiersin.org/journals/climate/articles/10.3389/fclim.2025.1558396/full',
      }),
    ]),
  }),
  ...
  sabatier: Object.freeze({
    ...
    // Audi e-gas Werlte 4,100 m² plot; 350 m³/h SNG; subtract cited PEM pad.
    basis: 'kgPerHour',
    intensity: 15.0,
    unitLabel: 'm²/(kg CH₄/h)',
    range: Object.freeze([14.6, 16.3]),
    floorM2: 9,
    quality: 'cited',
    evidence: Object.freeze([
      Object.freeze({
        label: 'Audi e-gas Werlte: 4,100 m² plot (electrolysis + methanation)',
        url: 'https://www.automotiveworld.com/news/world-premiere-audi-opens-power-to-gas-facility/',
      }),
      Object.freeze({
        label: 'IEA Bioenergy: 6 MWel + 350 m³/h SNG → 251 kg/h; 4,100/251=16 m²/(kg/h); minus PEM 0.072 m²/kW×6 MW=432 m² → 15 m²/(kg CH₄/h) methanation+BOP',
        url: 'https://task44.ieabioenergy.com/wp-content/uploads/sites/12/2021/12/Task-44-Best-Practice_e-gas-Werlte_Germany.pdf',
      }),
    ]),
  }),
  methanol: Object.freeze({
    ...
    range: Object.freeze([0.69, 3.1]),
    floorM2: 12,
    quality: 'cited',
    evidence: Object.freeze([
      Object.freeze({
        label: 'IGP Myrtle Grove: 140 acres for 7.2 Mt/y (4×1.8 Mt/y) → 0.69 m²/(kg/h)',
        url: 'https://www.ogj.com/refining-processing/gas-processing/new-plants/article/17296020/louisiana-approves-grassroots-methanol-complex',
      }),
      Object.freeze({
        label: 'Methanex Geismar G3: 156-acre site for 1.8 Mt/y → 3.1 m²/(kg/h); mid of 0.69–3.1 is 1.9',
        url: 'https://www.areadevelopment.com/newsItems/7-22-2019/methanex-geismar-louisiana.shtml',
      }),
    ]),
  }),
  swro: Object.freeze({
  ...
  med: Object.freeze({
    ...
    intensity: 0.16,
    unitLabel: 'm²/(m³/d)',
    range: Object.freeze([0.16, 0.16]),
    floorM2: 16,
    quality: 'cited',
    evidence: Object.freeze([
      Object.freeze({
        label: 'SIDEM Az-Zour North MED: <80,000 m² for 107 MIGD (486,400 m³/d) → <0.164 m²/(m³/d)',
        url: 'https://www.sidem-desalination.com/az-zour-north-phase-1-iwpp',
      }),
    ]),
  }),
  msf: Object.freeze({
    ...
    evidence: Object.freeze([
      Object.freeze({
        label: 'Ras Al-Khair MSF evaporator 123×33.7 m for 91,000 m³/d → 0.046 m²/(m³/d) vessel only; full plant plot not published',
        url: 'https://www.desalination.biz/desalination/record-breaking-msf-desalination-unit-sails-for-saudi/',
      }),
    ]),
  }),
  desal: Object.freeze({
  ...
  'brine-minerals': Object.freeze({
    ...
    range: Object.freeze([15.0, 15.0]),
    floorM2: 20,
    quality: 'cited',
    evidence: Object.freeze([
      Object.freeze({
        label: 'Smackover Lithium SWA CPF: 118 acres for 200,000 bbl/d (1,325 m³/h) brine → 15 m²/(t feed/d) at 1 t/m³',
        url: 'https://www.finanznachrichten.de/nachrichten-2025-09/66346851-standard-lithium-smackover-lithium-announces-positive-definitive-feasibility-study-results-for-its-south-west-arkansas-project-399.htm',
      }),
    ]),
  }),
  asu: Object.freeze({
    ...
    intensity: 6.5,
    unitLabel: 'm²/(t N₂/d)',
    range: Object.freeze([6.5, 6.5]),
    floorM2: 14,
    quality: 'cited',
    evidence: Object.freeze([
      Object.freeze({
        label: 'Coega Green Ammonia EIA: ASU ~1.6 ha for 900,000 t N₂/y → 6.5 m²/(t N₂/d)',
