    ...
    graph: {
      nodes: [
        ...
        { id: 'seawater', unit: 'material-source', params: { stream: seawater }, economics: { ...tea.bindCost('seawater'), unitCost: 0.001 } },
        {
          ...
          economics: tea.bindCapexPack('solar-pv', { capacity: solarKWp }),
        },
        {
          id: 'heat',
          unit: 'heat-source',
        ...
        },
        {
          ...
          economics: tea.bindCapexPack('dac', { capacity: 100 }),
        },
        {
          id: 'swro',
          unit: 'swro',
        ...
        },
        {
          ...
          economics: tea.bindCapexPack('methanol', { capacity: 100 }),
        },
        ...
        { id: 'methanol-product', unit: 'material-sink', economics: tea.bindSale('methanol') },
