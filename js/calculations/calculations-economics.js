...
Object.assign(Calc, {
  ...
  calculateEconomics(state, context) {
    const {
      ...
      exploratoryModules, waterSystems,
    } = context;
    ...
    const revenue = {
      ...
      water: waterMarketRevenue,
      waterCredit: waterCreditAnnualM3 * (state.desalinationPrice || 0),
      brineMining: brineMining?.marketCappedRevenue || 0,
    ...
    for (let year = 1; year <= state.analysisHorizonYears; year++) {
      ...
      const yearlyRevenue = {
        ...
        water: revenue.water * degradationFactor,
        waterCredit: revenue.waterCredit * degradationFactor,
        brineMining: revenue.brineMining * degradationFactor,
