...
- `engine/map-site.js`: map-picker geometry and screening overlays (`haToRadiusM`, `circlePolygon`, PV and water bands, layer cites, network markers). Not a permit, assay, or surveyed layout.
