...
| process-brine assays (sabkha, Atacama, Mackay, GSL, Salton Sea, Uyuni, Qaidam, Danakil, Searles) | Cited inland/coastal process-brine majors (not Millero seawater). Gulf sabkha Wood 2002 / MDPI Hydrology 2020; Atacama + GSL + Uyuni Murphy & Haji 2022 Table 1; Lake Mackay Agrimin EPA memo medians; Salton Sea Stringfellow & Dobson 2021 Energies Table 2 / NREL TEA OSTI 1782801 ppm family; Qaidam Kunteyi Ren et al. 2023 Table 1 sample 5; Danakil Dallol Garrett 2004 / Martini 1969; Searles Teeple 1929. Screening densities 1.20 / 1.23 / 1.16 / 1.10 / 1.20 / 1.22 / 1.22 / 1.20 / 1.30 kg/L. Ions omitted when not in the cite (no invented Li+/Br−). | Preset `site.resources.brine` / `createAbundanceCase({ assayId })` | **cited** (composition) + **screening** (density, intake volume) | Frozen 2026-09-20 in `data/*-brine.json` (Salton Sea + Uyuni/Qaidam/Danakil/Searles 2026-09-21). Bound where geography holds (Taweelah/Ras Laffan/Ras Al-Khair → sabkha; Mejillones → Atacama nucleus; Port Hedland → Lake Mackay regional; inland `au-lake-mackay`, `us-great-salt-lake`, `us-salton-sea`, `bolivia-uyuni`, `china-qaidam`, `ethiopia-danakil`, `us-searles-lake`). Literature ≠ concession. |
