...
test('root chrome exposes four tabs and keeps Network copy without Empire', () => {
  ...
  assert.ok(html.indexOf('data/uyuni-lithium-brine.js') < html.indexOf('data/site-assays.js'));
  assert.ok(html.indexOf('data/qaidam-brine.js') < html.indexOf('data/site-assays.js'));
  assert.ok(html.indexOf('data/danakil-brine.js') < html.indexOf('data/site-assays.js'));
  assert.ok(html.indexOf('data/searles-lake-brine.js') < html.indexOf('data/site-assays.js'));
